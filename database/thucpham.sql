...
--
-- Table structure for table `khachdathang`
--
...
--
-- Dumping data for table `khachdathang`
--
...
CREATE TABLE `khachhang` (
  ...
  `matkhaukhachhang` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 0, '2024-04-10 11:53:41'),
(2, 20, '2024-04-09 11:27:01'),
(3, 20, '2024-04-15 06:53:41'),
(4, 15, '2024-04-10 11:53:41');
...
CREATE TABLE `lienhe` (
  ...
  `tenlienhe` varchar(100) NOT NULL,
  `emaillienhe` varchar(100) NOT NULL,
  `chudelienhe` varchar(100) NOT NULL,
  `noidunglienhe` varchar(500) NOT NULL,
...
CREATE TABLE `nguoidung` (
  ...
  `emailnguoidung` varchar(50) NOT NULL,
...
(18, 'thuan', 'admin@gmail.com', 123),
(19, 'huy', 'huy@gmail.com', 123);
...
(89, 'Rau xà lách', 1, 50, 2000, 'xa-lach-la-xoan.jpg', 'Rau ngon tươi sạch', 1, 1),
(90, 'Rau muống', 1, 50, 3000, 'th.jfif', 'Rau ngon tươi sạch', 1, 2);
...
--
-- Table structure for table `trogiup`
--

CREATE TABLE `trogiup` (
  `matrogiup` int(10) NOT NULL,
  `tentrogiup` varchar(100) NOT NULL,
  `emailtrogiup` varchar(100) NOT NULL,
  `sdttrogiup` int(15) NOT NULL,
  `noidungtrogiup` varchar(200) NOT NULL,
  `ngayyeucau` datetime NOT NULL,
  `trangthai` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `trogiup`
--
...
--
-- Indexes for table `khachdathang`
--
...
--
-- AUTO_INCREMENT for table `khachdathang`
--
ALTER TABLE `khachdathang`
...
--
ALTER TABLE `nguoidung`
  MODIFY `manguoidung` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `sanpham`
  MODIFY `masanpham` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
-- AUTO_INCREMENT for table `trogiup`
--
ALTER TABLE `trogiup`
